...
class AppCustomCurvedEges extends CustomClipper<Path> {
  @override
  Path getClip(Size size) {
    ...
    path.quadraticBezierTo(
        firstPoint.dx, secondPoint.dy, secondPoint.dx, secondPoint.dy);
    ...
    path.quadraticBezierTo(
        fifthPoint.dx, fifthPoint.dy, sixthPoint.dx, sixthPoint.dy);
